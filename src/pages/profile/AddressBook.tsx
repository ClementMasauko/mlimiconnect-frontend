...
export default function AddressBook() {
  ...
  return (
    <div className="mx-auto max-w-6xl"><div className="mb-7"><p className="text-sm font-bold uppercase tracking-[.15em] text-green-700">My account</p><h1 className="mt-1 text-3xl font-extrabold tracking-tight dark:text-white">Addresses & contacts</h1><p className="mt-2 text-slate-500">Keep trusted trading partners and delivery details close at hand.</p></div><div className="grid gap-7 lg:grid-cols-[240px_1fr]"><Card className="h-fit p-3"><AccountNav /></Card><div>
              ...
              <Card key={contact.id} className="p-6 hover:shadow-lg transition-shadow">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  ...
                  <div className="flex gap-3">
                    <Button variant="outline" size="sm" className="flex items-center gap-1.5" onClick={() => navigate(`/app/messages/${contact.id}`)}>
