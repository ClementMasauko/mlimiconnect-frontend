...
export default function ResetPassword() {
  ...
  if (success) {
    return (
      <AuthShell title="Password updated" description="Your account is ready for secure sign-in.">
        <motion.div
  ...
  return (
    <AuthShell title={step === "verify" ? "Enter your reset code" : "Choose a new password"} description={step === "verify" ? "Enter the six-digit code sent to your phone or email." : "Set a strong password to keep your account secure."}>
      <motion.div
