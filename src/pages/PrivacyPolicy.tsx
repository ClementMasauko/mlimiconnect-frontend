      ...
      <div className="max-w-5xl mx-auto">
        ...
        <Card className="p-8 md:p-12 prose dark:prose-invert max-w-none">
          <p className="text-lg leading-relaxed mb-8">
            This pilot privacy notice explains how MlimiConnect processes information when you use the website, mobile application, configured USSD channels, and related services. Features described here apply only when they are enabled. The operating entity and privacy contact must be confirmed in this notice before public launch.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-3 mb-8">
            <li><strong>Account and organisation information:</strong> Username, phone number, email, general location, account role, and business documents that an organisation or transporter chooses to upload for review.</li>
            <li><strong>Transaction information:</strong> Orders, payment references, refunds, ledger entries, settlements and payout status when payment services are enabled. The configured licensed payment provider processes payment credentials under its own terms.</li>
            <li><strong>Usage and device data:</strong> IP address, browser and app information, requested route, response status, performance timing, and privacy-filtered crash diagnostics.</li>
            ...
            <li><strong>Address searches:</strong> When you press Search in a pickup or delivery form, the place text is sent through the MlimiConnect backend to the configured geocoding provider. Do not enter names, phone numbers or confidential information. Confirmed labels and coordinates may be stored with the delivery.</li>
          ...
          <ul className="list-disc pl-6 space-y-3 mb-8">
            ...
            <li>With the configured payment provider when a user initiates an enabled payment flow</li>
            ...
            <li>With the configured geocoding provider when you explicitly submit a location search. Results are cached to reduce repeated external requests and provider attribution is displayed where required.</li>
          ...
          <div className="mt-16 p-8 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700 text-center">
            <p className="text-lg font-medium text-gray-700 dark:text-gray-300 mb-6">
              Questions, access requests, corrections, or deletion requests can be submitted through the contact page or to:
            </p>
            <a
