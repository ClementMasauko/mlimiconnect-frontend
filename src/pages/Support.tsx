    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          <a href="mailto:support@mlimiconnect.mw" className="block">
            <Card className="p-6 text-center hover:shadow-xl transition-all duration-300 group">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <Card className="p-8">
            ...
            <Button variant="outline" className="w-full" asChild><a href="mailto:support@mlimiconnect.mw">Send Email</a></Button>
          </Card>
          ...
          <Card className="p-8">
            ...
            <Button variant="outline" className="w-full" asChild><a href="https://wa.me/265999123456" target="_blank" rel="noreferrer">Start WhatsApp Chat</a></Button>
          </Card>
        </div>
