...
import { Bell, ChevronRight, MapPin, Settings, ShieldCheck, User } from "lucide-react";
import { useTranslation } from "react-i18next";

const links = [{ to: "/app/profile", key: "personalInformation", icon: User }, { to: "/app/profile/address-book", key: "addressesContacts", icon: MapPin }, { to: "/app/profile/notifications-management", key: "notifications", icon: Bell }, { to: "/app/profile/security", key: "secureAccess", icon: ShieldCheck }, { to: "/app/profile/settings", key: "accountPreferences", icon: Settings }];
